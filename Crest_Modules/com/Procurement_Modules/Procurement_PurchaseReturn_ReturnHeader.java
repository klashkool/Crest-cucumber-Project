...
public class Procurement_PurchaseReturn_ReturnHeader extends Base {
	...
	public static void Update_ReturnHeader() {
		...
		status_dd.selectByVisibleText("Shipped");
		...
		String returnStatus = WebdriverWait.findElement("xpath", "//*[@id='content-main-section']/div/div[2]/table/tbody/tr[2]/td[4]").getText();
